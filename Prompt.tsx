...
export function Prompt() {
  ...
  async function handleSend() {
    ...
    try {
      ...
      // Fixed: Initialize GoogleGenAI instance right before use
      ...
      // Fixed: Set thinkingBudget based on feature flag
      ...
      const responseObj = await ai.models.generateContent(requestPayload);

      // Fixed: Access .text property directly (not as a function)
